...
def loadFlags(strFilePath:str):
    """
    Description:
    =======================================================
    Load the compilation flags to help complete.

    Args:
    =====================================================
    - strFilePath:  type: str, the file path
    ...
    with open(strFilePath, "r") as oReader:
        for strLine in oReader.readlines():
            ...
            flags.append(strLine.strip())
        # End of for-loop
    # End of with-block
# End of loadFlags

loadFlags(p.expanduser("~") + "/.vim/bundle/YouCompleteMe/compile_includes.data")
